...
//    private JButton button2 =null;
    ...
    public EditCellDialog(DefaultGraphCell cell) {
        ...
        text_name = new JTextField((String) MyGraphConstants.getName(cell.getAttributes()));
        text_name.setBounds(96, 11, 508, 27);
        label_commands = new JLabel("Commands");
        label_commands.setBounds(10, 61, 87, 27);
        text_commands = new JTextArea((String) MyGraphConstants.getCommands(cell.getAttributes()));
...
//        //
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                cell.setUserObject(text_name.getText().toString());
                MyGraphConstants.setName(cell.getAttributes(), text_name.getText().toString());
                //
                MyGraphConstants.setCommands(cell.getAttributes(), text_commands.getText().toString());
